<%-- 
    Document   : inputwth
    Created on : Dec 28, 2016, 8:41:21 PM
    Author     : HafidS 
--%>
...
//                out.print(tglold);out.print(schdt);
            ...
            hg = schdt;
              ...
              hg = schdt+":00";  
                ...
                ps.setString(2, "3");
                ps.setString(3, "sukses buat Scheduler untuk co_id "+co_id.replaceAll("[^a-zA-Z0-9 :-]", "_")+" ,bnumber "+bnum.replaceAll("[^a-zA-Z0-9 :-]", "_")+" dan tanggal "+hg.replaceAll("[^a-zA-Z0-9 :-]", "_"));
                ps.executeUpdate();
