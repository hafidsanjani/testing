<%-- 
    Document   : inputupl1
    Created on : Feb 7, 2017, 5:21:12 PM
    Author     : HafidS 
--%>
...
//    String schdt = (request.getParameter("asd") != null ? request.getParameter("asd") : "");
            ...
            String balance = (String)session.getValue("balance");
            ...
            while (rs2.next()){
            sids.add(rs2.getString("pck_name"));
            }
...
//                                out.print("wew"+negara[1]+"wew");
                                if (negara[0].contains("E+")){
                                 //return
                                    ...
                                    ps.setString(1, usr);
                                    ps.setString(2, "3");
                                    ps.setString(3, "upload Record "+er+" format nya bukan 628xxx");
                                    ps.executeUpdate();
                                    %>
                                    <script type="text/javascript" language="JavaScript">
                                    var er= "<%=er%>";
                                ...
                                if(nomer.substring(0, 3).equals("628")){
									list.add(nomer); 
									...
									if (Arrays.asList(allow4).contains(negara[1])) {//cek packet yang di upload
                                        query = "select kuota from package_list where pck_name=?";
										//out.print(query);
                                        ps = con.prepareStatement(query);
                                        ps.setString(1, negara[1]);
                                        rd1 = ps.executeQuery();
                                        if (rd1.next()){
                                            gf= rd1.getInt("kuota");
                                        }
           ...
           if (rd2.next()){
               bln=rd2.getInt("balance");
                                        ...
                                        if (juml>bln){
                                            ...
                                            ps.setString(1, usr);
                                            ps.setString(2, "3");
                                            ps.setString(3, "Balance co_id "+co_id+" tidak mencukupi untuk melakukan semua transaksi");
                                            ps.executeUpdate();
//                                            String er = nomer; 
//                                    %>
                                <script type="text/javascript" language="JavaScript">
//                                   
                                    alert("Maaf Balance anda tidak mencukupi untuk melakukan semua transaksi. semua transaksi di batalkan !!!");
//                                    history.go(-1);
                                    location = 'main.jsp?menu=rp1';
                                    </script>   
                                   <%
                                   return;
											...
											//out.print(query);
                                            ps.setString(1, co_id);
                                            ps.setString(2, nomer);
                                            ps.setString(3, negara[1]);
                                            ps.setString(4, hg);
                                            ps.setString(5, "0");
                                            ps.setString(6, "0");
                                            ps.executeUpdate();
...
//                                            }
                                            ...
                                            ps.setString(1, usr);
                                            ps.setString(2, "3");
                                            ps.setString(3, "Upload Packet "+er+" tidak ada di dalam list packet yang di perbolehkan");
                                            ps.executeUpdate();
//                                    %>
                                    <script type="text/javascript" language="JavaScript">
                                    var er= "<%=er%>";
...
//                                    history.go(-1);
                                   ...
                                   return;  
                                            ...
                                            ps.setString(1, usr);
                                            ps.setString(2, "3");
                                            ps.setString(3, "Upload Msisdn "+er+" bukan Telkomsel Subscriber.");
                                            ps.executeUpdate();
//                                    %>
                                <script type="text/javascript" language="JavaScript">
                                    var er= "<%=er%>";
...
//                                    history.go(-1);
                                ...
                                //panjang kurang dari 7
                                    ...
                                    String er = nomer; 
                                     ...
                                     String sql = "insert into activity_log (tanggal, username, id_activity, activity_detail) values (now(), ?, ?, ?)";
                                            ...
                                            ps.setString(1, usr);
                                            ps.setString(2, "3");
                                            ps.setString(3, "Upload Record "+er+" panjangnya kurang dari 7 digit.");
                                            ps.executeUpdate();
                                    %>
                                    <script type="text/javascript" language="JavaScript">
                                    var er= "<%=er%>";
                                   ...
                                   return;
                                    ...
                                    String sql = "insert into activity_log (tanggal, username, id_activity, activity_detail) values (now(), ?, ?, ?)";
                                            ...
                                            ps.setString(1, usr);
                                            ps.setString(2, "3");
                                            ps.setString(3, "Record "+ln+" yang anda upload salah format.");
                                            ps.executeUpdate();
                                %>
                                    <script type="text/javascript" language="JavaScript">
                                    var ln = "<%=ln%>";
                        ...
                        for (String arrayElement : list){
                            if(!set.add(arrayElement)){
                                ...
                                %>
                                <script type="text/javascript" language="JavaScript">
                                var kuc = "<%=arrayElement.replaceAll("[^a-zA-Z0-9 :-]", "")%>";
            ...
            String sql = "insert into activity_log (tanggal, username, id_activity, activity_detail) values (now(), ?, ?, ?)";
                                            ...
                                            ps.setString(1, usr);
                                            ps.setString(2, "3");
                                            ps.setString(3, "sukses Upload co_id "+co_id);
                                            ps.executeUpdate();
            }
