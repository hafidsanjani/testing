<%-- 
    Document   : imidiate
    Created on : Mar 14, 2017, 1:46:39 PM
    Author     : HafidS 
--%>
...
//            alert(c);
        ...
        if(document.fsearch.bnum.value == "") {
        ...
        document.fsearch.pcket.focus();    
            ...
            if(jns=="Bulk"){
                   document.fsearch.action="inputime1.jsp";
                   }else{
                   document.fsearch.action="inputime.jsp";  
                   }
...
//            var cx1 = cx+":00"; 
            ...
            var b = a.substring(0,3);
            var c = a.length;
        if(document.fsearch.bnum_edt.value == "") {
        alert("Bnumber Harus Diisi !!!");
      ...
      function edt(i){
          ...
          document.fsearch.proses.value="edit";
          document.fsearch.action="main.jsp?menu=gab&menu1=whst1";
          document.fsearch.submit();
      }
...
<!--                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="pcket_edt" id="pcket_edt" class="form-control" >
                            ...
                            <%
                                while (rs1.next()){
                                    if (pckt.equals(rs1.getString("pck_name"))){
                             %>  
					...
					<tbody>
						...
						<tr>
							<td><input type="hidden" name="<%="dtgf_"+j%>" value="<%=rs.getString("execution_time")%>"><%=rs.getString("execution_time")%></td>
                                                        ...
                                                        <td><input type="hidden" name="<%="packet_"+j%>" value="<%=rs.getString("pck_keyword")%>"><%=rs.getString("description")%></td>
                                                        <td>
                                                            <% 
